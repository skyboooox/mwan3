...
18. [Changelog](#18-changelog)
    - 18.1 [Version 3.6.11](#181-version-3611)
    - 18.2 [Version 3.6.10](#182-version-3610)
    - 18.3 [Version 3.6.9](#183-version-369)
    - 18.4 [Version 3.6.8](#184-version-368)
    - 18.5 [Version 3.6.7](#185-version-367)
    - 18.6 [Version 3.6.6](#186-version-366)
    - 18.7 [Version 3.6.5](#187-version-365)
    - 18.8 [Version 3.6.4](#188-version-364)
    - 18.9 [Version 3.6.3](#189-version-363)
    - 18.10 [Version 3.6.2](#1810-version-362)
    - 18.11 [Version 3.6.1](#1811-version-361)
    - 18.12 [Version 3.6](#1812-version-36)
    - 18.13 [Version 3.5.3](#1813-version-353)
    - 18.14 [Version 3.5.2](#1814-version-352)
    - 18.15 [Version 3.5.1](#1815-version-351)
    - 18.16 [Version 3.5](#1816-version-35)
    - 18.17 [Version 3.4.1 (Unreleased)](#1817-version-341-unreleased)
    - 18.18 [Version 3.4](#1818-version-34)
    - 18.19 [Version 3.3.5](#1819-version-335)
    - 18.20 [Version 3.3.4](#1820-version-334)
    - 18.21 [Version 3.3.3](#1821-version-333)
    - 18.22 [Version 3.3.2](#1822-version-332)
    - 18.23 [Version 3.3.1](#1823-version-331)
    - 18.24 [Version 3.3](#1824-version-33)
    - 18.25 [Version 3.2.3](#1825-version-323)
    - 18.26 [Version 3.2.2](#1826-version-322)
    - 18.27 [Version 3.2.1](#1827-version-321)
    - 18.28 [Version 3.2](#1828-version-32)
    - 18.29 [Version 3.1.4](#1829-version-314)
    - 18.30 [Version 3.1.3](#1830-version-313)
    - 18.31 [Version 3.1.2](#1831-version-312)
    - 18.32 [Version 3.1.1](#1832-version-311)
...
| `mwan3_set_user_rules` | Flushes `mwan3_rules` chain, then iterates all rule configs in config order, calling `mwan3_set_user_nft_rule`for both IPv4 and IPv6. Uses a single batch. |
...
**Summary:** Fix the nft rule rendering order such that it preserves strict config order.

---

### mwan3: render user rules in config order

The user rule renderer looped over address family first and the config rules second, so the installed `mwan3_rules` chain held the entire IPv4 render pass followed by the entire IPv6 render pass. Config order was preserved within each pass but not across the pass boundary.

A `family=any` rule with no IP-version-specific match element (for example a bare protocol and port rule, or an fwmark rule) is emitted once, on the IPv4 pass, as a single family-agnostic line that also matches IPv6 traffic at runtime. Because the whole IPv4 pass rendered first, that line always landed ahead of every IPv6-only rule in the chain regardless of its position in the config, and shadowed any IPv6 rule the configuration placed before it. Rule evaluation is first match, so no config ordering could place an IPv6-only rule ahead of a family-agnostic one, and reordering rules in the config silently failed to change evaluation order.

Invert the loop nesting: iterate the config rules in order and render each rule's IPv4 and IPv6 variants at that rule's position. The per-rule, per-family emission function is unchanged, so every rendered line is identical; only the order of the lines in `mwan3_rules` changes, and it now always matches config order. The chain is a flat first-match list with no structural dependency on the old pass grouping, and per-rule sticky chains and sets are keyed by rule and family, so their content is unaffected.

For configurations that interleave family-agnostic rules with family-specific ones, evaluation order now follows config order strictly.
...
### 18.17 Version 3.4.1 (Unreleased)
